...
class ParserModel(nn.Module):
    ...
    def __init__(self, embeddings, n_features=36,
        ...
        ### TODO:
        # 调用对应参数，创建大小合适的线性层，并使用xavier uniform初始化参数
        ...
        # 这里没必要预先定义softmax层，因为最后在forward函数中使用交叉熵损失函数的时候，会自动调用
    ...
    def forward(self, t):
        ...
        z1 = self.embed_to_hidden(embeddings)
        a1 = nn.ReLU()(z1)
        a1 = self.dropout(a1)
        logits = self.hidden_to_logits(a1)
